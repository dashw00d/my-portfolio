...
export default function CustomBuildCta({
  ...
  return (
    ...
    >
      ...
      <span className="relative flex w-full items-center gap-3 rounded-[calc(1rem-1px)] bg-white px-4 py-4 shadow-lg shadow-brand-900/10 sm:gap-4 sm:px-6">
        <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-600 to-accent-600 text-white shadow-md shadow-brand-900/20">
        ...
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-brand-200 bg-brand-50 text-brand-600 transition duration-300 group-hover:translate-x-0.5 group-hover:border-transparent group-hover:bg-brand-600 group-hover:text-white">
