...
const PROOF_POINTS = [
  {
    ...
    description:
      "Generated by mining a client's 15 years of staffing logs into usable demand signals.",
  ...
  },
  {
    ...
    value: "Any-use-case architecture",
    description:
      "Reusable orchestration patterns for support, ops, content, and growth workflows.",
    accent: "text-success-600",
    bar: "before:bg-success-500",
  },
  {
    icon: LineChart,
    label: "2026-ready stack",
    value: "Laravel 12 + AI tooling",
    description:
      "Production systems using modern infra, automation, and measurable delivery loops.",
            ...
            <div className="mb-10 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="mt-0.5 text-sm text-zinc-500">
                  Automation Systems Engineer • Laravel 12 • AI Agent Workflows (2026)
                </div>
              </div>
            </div>
              ...
              <CustomBuildCta
                ...
                decoration={
                  <img
                    ...
                    width={1774}
                    height={887}
                    className="pointer-events-none absolute bottom-full left-1/2 z-10 hidden h-auto w-44 -translate-x-1/2 translate-y-[22%] select-none lg:block xl:w-48"
                  />
                }
              />
            </div>
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="max-w-[13rem] space-y-1 text-right text-xs text-highlight-200/70">
                    ...
                    <p className="text-highlight-100/80">
                      Audit call, architecture map, and execution plan tailored to your growth bottleneck.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-3 text-sm">
                  <div className="flex items-start gap-3 rounded-2xl border border-white/15 bg-white/[0.07] px-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-highlight-100/80">
                        Turn legacy logs into campaign signals, segments, and conversion opportunities.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 rounded-2xl border border-white/15 bg-white/[0.07] px-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-highlight-100/80">
                        Composable automations that adapt to support, ops, content, and revenue workflows.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 rounded-2xl border border-white/15 bg-white/[0.07] px-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-highlight-100/80">
                        Laravel 12, modern observability, and AI-ready architecture without enterprise bloat.
                      </p>
                    </div>
                  </div>
                </div>
